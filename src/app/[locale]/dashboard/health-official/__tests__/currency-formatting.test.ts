...
describe('Health Official Dashboard - Currency Format Consistency - Property 6', () => {
  /**
   * Property-based test: Currency formatting for health metrics costs
   * For any supported locale and any valid health metrics cost,
   * the formatted currency should contain the INR symbol and be properly formatted.
   *
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should format health metrics costs consistently for all supported locales', () => {
    fc.assert(
      fc.property(
  ...
  /**
   * Property-based test: Currency formatting for maintenance costs
   * For any supported locale and any valid maintenance cost,
   * the formatted currency should include decimal places.
   *
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should format maintenance costs with decimal places for all locales', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
        fc.integer({ min: 1, max: 10000000 }), // Start from 1 to avoid edge case with 0
  ...
  /**
   * Property-based test: Currency formatting for resource allocation costs
   * For any supported locale and any valid resource allocation cost,
   * formatting the same amount multiple times should produce identical results (idempotence).
   *
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should produce consistent formatting for resource allocation costs across multiple calls (idempotence)', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
        fc.integer({ min: 0, max: 10000000 }),
   ...
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should apply locale-specific grouping for large resource allocation amounts', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
   ...
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should correctly format zero and small health metrics amounts for all locales', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
   ...
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should always use INR currency symbol regardless of locale in health official dashboard', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
        fc.integer({ min: 0, max: 10000000 }),
  ...
  /**
   * Property-based test: Currency formatting for staffing costs
   * For any supported locale and any valid staffing cost,
   * the formatted currency should be consistent and properly formatted.
   *
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should format staffing costs consistently for all supported locales', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
        fc.integer({ min: 0, max: 10000000 }),
        (locale: Locale, cost: number) => {
          // Act: Format currency using Intl API
          const formatter = new Intl.NumberFormat(locale, {
            style: 'currency',
            currency: 'INR',
            minimumFractionDigits: 2,
  ...
  /**
   * Property-based test: Currency formatting for ambulance operations costs
   * For any supported locale and any valid ambulance operations cost,
   * the formatted currency should be consistent and properly formatted.
   *
   * Feature: multilingual-indian-languages, Property 6: Currency Format Consistency
   */
  it('should format ambulance operations costs consistently for all supported locales', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...locales),
        fc.integer({ min: 0, max: 10000000 }),
