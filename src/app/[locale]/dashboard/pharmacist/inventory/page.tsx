...
export default function InventoryPage() {
  ...
  const onSubmit = async (data: InventoryFormValues) => {
    ...
    try {
      if (existingMedicine) {
        ...
        toast({
          title: getSuccessMessageTranslation('stockUpdated', t),
        ...
        toast({
          title: getSuccessMessageTranslation('medicineAdded', t, { medicineName: data.medicineName }),
        });
      }
      form.reset();
    } catch (error) {
  ...
  const handleSaveEditing = async (medicineId: string) => {
    ...
    try {
      ...
      setEditingMedicineId(null);
      toast({
        title: getSuccessMessageTranslation('inventoryUpdated', t),
