...
const menuItems = [
  ...
  {
    href: '/dashboard/data-entry-operator/districts-hospitals',
    label: 'Districts & Hospitals',
    icon: Building2,
  },
  {
    href: '/dashboard/data-entry-operator/hospital-infrastructure',
    label: 'Hospital Infrastructure',
    icon: Stethoscope,
  },
  {
    href: '/dashboard/data-entry-operator/hospital-data',
    label: 'Hospital Data Entry',
    icon: FileEdit,
  },
  {
    href: '/dashboard/data-entry-operator/profile',
    label: 'Profile',
    icon: User,
  },
];
